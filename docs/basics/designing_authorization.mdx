...
In the example above, a path to e.g. Task-1 would be `/accounts/account-1/projects/project-1/tasks/task-1`. If you want to
reference all projects, for the account, you can use `/accounts/account-1/projects`, etc.
